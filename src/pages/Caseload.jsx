  ...
  return (
    <>
      ...
      <div className="h-full bg-gray-900 ">
        ...
        <main>
          <div className="text-gray-200 overflow-x-auto bg-gray-800 mx-auto max-w-7xl px-4 py-6 m-10 sm:px-6 lg:px-8 rounded-4xl">
            <table className="min-w-full divide-y-2 divide-gray-600">
              <thead className="ltr:text-left rtl:text-right">
                <tr className="*:font-medium  color-white">
                  <th className="px-3 py-2 whitespace-nowrap ">Name</th>
                  <th className="px-3 py-2 whitespace-nowrap">DoB</th>
                  <th className="px-3 py-2 whitespace-nowrap">Disability</th>
                  <th className="px-3 py-2 whitespace-nowrap">Case Manager</th>
                </tr>
              </thead>

              <tbody className=" divide-gray-600 divide-y-2">
                {caseload?.map(
                  ({ id, name, eligibility_category, dob, case_manager }) => (
                    <tr key={id} className="*:first:font-medium">
                      <td className="px-3 py-2 whitespace-nowrap">
                        <Link to={`/caseload/${id}`}>{name}</Link>
                      </td>
                      <td className="px-3 py-2 whitespace-nowrap">{dob}</td>
                      <td className="px-3 py-2 whitespace-nowrap">
